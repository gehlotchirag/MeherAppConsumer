angular.module('starter.controllers')
    ...
    .controller('offersCtrl', function($scope, $http, $stateParams,CartData,StoreData,$ionicLoading,$ionicSlideBoxDelegate,$location,$ionicFilterBar) {
      ...
      $scope.checkExisting = function () {
        ...
        console.log($ionicSlideBoxDelegate.selected())
      ...
      $scope.getProducts = function(productCategory,pageNumber) {
        return $http.get('http://getmeher.com:3000/offers/'+productCategory+'/'+pageNumber)
      };
